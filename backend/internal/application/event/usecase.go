...
type UseCase interface {
	...
	ListEventApprovedParticipants(ctx context.Context, userID, eventID uuid.UUID, input ListEventCollectionInput) (*ListEventApprovedParticipantsResult, error)
	ListEventPendingJoinRequests(ctx context.Context, userID, eventID uuid.UUID, input ListEventCollectionInput) (*ListEventPendingJoinRequestsResult, error)
